...
const solutions = [
  { 
    title: 'Integrar', 
    description: 'e disponibilizar dados urbanísticos com regras do plano diretor em uma plataforma unificada e acessível',
    image: '/images/place/government/b2g_integrar.png'
  },
  { 
    title: 'Acelerar', 
    description: 'a aprovação de projetos com orientação por Inteligência Artificial regulatória, reduzindo tempo e custos operacionais',
    image: '/images/place/government/b2g_acelerar.png'
  },
  { 
    title: 'Otimizar', 
    description: 'a política de outorga onerosa com base em dados de mercado atualizados e análises territoriais precisas',
    image: '/images/place/government/b2g_otimizar.png'
  },
  { 
    title: 'Gerar', 
    description: 'previsibilidade, receita e capital político em uma interface acessível ao cidadão, promovendo transparência e eficiência',
    image: '/images/place/government/b2g_gerar.png'
  }
]
...
<template>
  ...
  >
    ...
    <div v-if="isMobile" class="w-full h-full flex flex-col px-6 py-16">
      <!-- Header -->
      <div class="mb-6">
        <p class="text-neutral-500 text-base font-light font-['Manrope'] mb-2">GOVERNOS</p>
        <h2 class="text-zinc-900 text-xl font-medium font-['Manrope']">
          Com o gêmeo digital urbano é possível:
        </h2>
      </div>
      ...
      <a
        ...
        class="w-full px-6 h-10 rounded-[20px] border border-neutral-500 text-neutral-500 text-base font-light font-['Manrope'] hover:bg-neutral-500 hover:text-white transition-colors cursor-pointer uppercase flex items-center justify-center"
      >
        <span class="uppercase">conhecer plataforma</span>
      </a>
    </div>
      ...
      <div class="flex-1 h-[640px] flex">
        <div class="pl-16 pr-6 lg:pl-20 lg:pr-12 w-full max-w-lg flex flex-col">
          ...
          <div class="animate-solution-text mb-8">
            <p class="text-neutral-500 text-lg font-light font-['Manrope'] leading-6 mb-2">GOVERNOS</p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="animate-solution-text mt-12 px-6 h-9 rounded-[20px] border border-neutral-500 text-neutral-500 text-base font-light font-['Manrope'] leading-8 hover:bg-neutral-500 hover:text-white transition-colors cursor-pointer uppercase inline-flex items-center justify-center"
          >
            <span class="uppercase">conhecer plataforma</span>
          </a>
        </div>
